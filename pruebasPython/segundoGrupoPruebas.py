...
class PythonLoginP2(unittest.TestCase):
    ...
    def test_CP0006_IngresoNoPermitidoContraseñaVacía(self):
        driver = self.driver
    ...
    def test_CP0007_IngresoNoPermitidoContraseñaEspacios(self):
        driver = self.driver
        driver.get('http://127.0.0.1:8000')
        time.sleep(3)
    ...
    def test_CP00010_BloqueDeUsuarioPorContraseñaIncorrecta(self):
        ...
        self.assertEqual(self.base_url, new_url+"?bloqueado=True")

    def test_CP00011_RegistroNoPermitidoUsuarioVacio(self):
        driver = self.driver
        driver.get('http://127.0.0.1:8000')
        time.sleep(3)
    ...
    def test_CP00013_RegistroNoPermitidoUsuarioEspacios(self):
        driver = self.driver
        driver.get('http://127.0.0.1:8000')
        time.sleep(3)
