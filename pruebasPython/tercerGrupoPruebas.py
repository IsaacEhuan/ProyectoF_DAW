...
class PythonLoginP2(unittest.TestCase):
    ...
    def test_CP00014_RegistroNoPermitidoContraseñaVacía(self):
        driver = self.driver
    ...
    def test_CP00015_RegistroNoPermitidoContraseñaEspacios(self):
        driver = self.driver
        driver.get('http://127.0.0.1:8000')
        time.sleep(3)
    ...
    def test_CP00016_RegistroNoPermitidoContraseñanNoAlfanumérica(self):
        driver = self.driver
        driver.get('http://127.0.0.1:8000')
        time.sleep(3)
    ...
    def test_CP00017_RegistroNoPermitidoContraseñaSinFormato(self):
        driver = self.driver
        driver.get('http://127.0.0.1:8000')
        time.sleep(3)
    ...
    def test_CP00018_RegistroNoPermitidoUsarioRegistrado(self):
        driver = self.driver
        driver.get('http://127.0.0.1:8000')
        time.sleep(3)
        ...
        nombres = "Juan Perez"
        correo = "A20216399@alumnos.uady.mx"
        contraseniaC = "123abcdefg"
