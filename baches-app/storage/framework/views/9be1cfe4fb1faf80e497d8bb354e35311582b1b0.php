    ...
    <div class="container mt-5 formulario">
        <div class="row">
            ...
            <div class="col">
                ...
                <form action="<?php echo e(route('iniciarSecion')); ?>" method="POST" >
...
<?php echo $__env->make('layouts.plantilla', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ProyectoF_DAW\baches-app\resources\views/layouts/Inicio.blade.php ENDPATH**/ ?>